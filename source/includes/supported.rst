...
The uriwriter is a directive that will inject a simple form into the page for the user to copy/paste their connection string (without password of course) or type their server params in for self-managed MongoDB instances. Once populated, any content in code blocks that contain <URISTRING> will be replaced with a connection string.
...
Link roles
----------
This is how you :doc:`Reference docs content </server/delete>`

more roles to come as we complete the snooty migration.
